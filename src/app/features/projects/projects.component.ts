...
import { ColorOption } from '../../core/constantes/project-customization';
...
export class ProjectsComponent {
  ...
  navigateToTasks(projectId: string): void {
    ...
    //tasks/user/:idUsuario/project/:idProject

    this.router.navigate(['tasks/user/' + this.userInfo?.id + '/project/' + projectId]);
  }
  ...
  readonly colorOptions: ColorOption[] = [
    ...
    { id: 'emerald', nombre: 'Verde', bgClass: 'bg-emerald-100 dark:bg-emerald-950', textClass: 'text-emerald-600 dark:text-emerald-400' },
    { id: 'blue', nombre: 'Azul', bgClass: 'bg-blue-100 dark:bg-blue-950', textClass: 'text-blue-600 dark:text-blue-400' },
    { id: 'red', nombre: 'Rojo', bgClass: 'bg-red-100 dark:bg-red-950', textClass: 'text-red-600 dark:text-red-400' },
    { id: 'amber', nombre: 'Amarillo', bgClass: 'bg-amber-100 dark:bg-amber-950', textClass: 'text-amber-600 dark:text-amber-400' }
  ];
